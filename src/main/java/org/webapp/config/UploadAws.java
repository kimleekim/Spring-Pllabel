...
//직접적으로 AwsConnect 의 메서드를 사용하는 클래스이다
...
public class UploadAws {
    ...
    private static final Logger logger = (Logger) LoggerFactory.getLogger(UploadAws.class);
    ...
    public static String uploadFile(String uploadPath, String originalName, byte[] byteData) throws Exception {
        ...
        //AwsConnect 의 fileUpload 메서드로 파일을 업로드한다.
